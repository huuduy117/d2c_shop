        ...
        <div className="flex flex-col gap-8">
          <div>
            ...
            <p className="mt-4 max-w-2xl text-base leading-7 text-slate-600">
              Phase 0 đã hoàn thiện cấu trúc cơ bản: Next.js App Router,
              Tailwind, NextAuth, Drizzle ORM, API versioning, PDPA consent và
              admin middleware.
            </p>
          </div>
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            <Link
              href="/register"
              className="rounded-3xl border border-slate-200 bg-slate-50 px-5 py-6 text-center transition hover:border-slate-300 hover:bg-slate-100"
            >
          ...
          <div className="grid gap-4 rounded-3xl bg-slate-900 px-6 py-8 text-white sm:grid-cols-3">
            <div>
              ...
              <p className="mt-2 text-sm text-slate-300">
                Đã tạo folder /api/v1/ cho các route REST.
              </p>
            </div>
            <div>
              <p className="font-semibold">DB Schema</p>
              <p className="mt-2 text-sm text-slate-300">
                Drizzle schema và seed admin / chi nhánh mặc định.
              </p>
            </div>
            <div>
              <p className="font-semibold">PDPA Consent</p>
              <p className="mt-2 text-sm text-slate-300">
                Đăng ký yêu cầu đồng ý PDPA và lưu phiên bản điều khoản.
              </p>
            </div>
          </div>
        </div>
